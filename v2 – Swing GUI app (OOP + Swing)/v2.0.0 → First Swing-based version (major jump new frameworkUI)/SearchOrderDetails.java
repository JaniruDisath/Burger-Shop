...
public class SearchOrderDetails{
	...
	private int got =0;
	private CustomButton backtoHomePageS = new CustomButton("Back to Home Page","GREEN",200,"Best Customer"); 
	...
	public void openSearchOrderDetials(){	
		...
		//Back
		CustomButton backto = new CustomButton("Back","GREEN",200,"Best Customer"); 
